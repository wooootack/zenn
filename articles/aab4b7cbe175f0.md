...
こちらのコードは、`conn`が2つのリポジトリに渡されていることになり、コンパイルエラーになります。
...
[こちらのコメント](https://zenn.dev/link/comments/c768ac5e1c2b03)でもっと簡単なやり方を教えて頂きました！
そのため、**以下に記載されているやり方は冗長な方法になります**のでご注意ください！
