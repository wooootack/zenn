...
- 社員一人ひとりが**当事者意識**を持ち**リーダーシップ**を発揮することで、組織全体の**自律性**を高める
- 状況や内容に応じて異なる人間が**リーダーシップ**を発揮して、特定の**リーダー**に依存しない組織を作り出す

---

### ④ 正しいことをせよ (Do the right thing)
...
### ⑦ 経験を分かち合い、学び合え (Mentor and be mentored)
...
### ③ Y理論によるガバナンス (Theory Y Governance)
...
### ⑦ ネットワーク型組織 (Network Organization Structures)
